...
export const HeroInfo = ({ idSlug }: Props) => {

    const { data: superheroData, averagePower, getStatusColor, getCategoryColor, stInteligencia,
        stFuerza,
        stVelocidad,
        stResistencia, } = useHeroInfo(idSlug);
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                                <Badge className={`${getCategoryColor(superheroData?.category ? superheroData.category : '')} text-white`}>
                                    {superheroData?.category}
                                </Badge>
                                <Badge className={`${getStatusColor(superheroData?.status ? superheroData.status : '')} text-white`}>{superheroData?.status}</Badge>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={stFuerza} className="h-2" />
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={stInteligencia} className="h-2" />
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={stVelocidad} className="h-2" />
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={stResistencia} className="h-2" />
                                </CardContent>
                            </Card>
                        </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={stFuerza} className="h-4" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={stInteligencia} className="h-4" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={stVelocidad} className="h-4" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={stResistencia} className="h-4" />
                                        </div>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center py-2">
                                        ...
                                        <Badge className={`${getStatusColor(superheroData?.status ? superheroData.status : '')} text-white`}>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center py-2">
                                        ...
                                        <span className="font-semibold">
                                            {new Date().getFullYear() - Number.parseInt(superheroData?.firstAppearance ? superheroData?.firstAppearance : '1')} años
                                        </span>
                                    </div>
                                </CardContent>
                            </Card>
